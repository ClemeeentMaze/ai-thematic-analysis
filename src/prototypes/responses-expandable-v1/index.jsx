...
ThematicAnalysisV1.Title = "Responses: Expandable Rows";
ThematicAnalysisV1.Description = "Table rows that expand inline to reveal full transcript and text selection for highlighting";
ThematicAnalysisV1.Order = 12;
